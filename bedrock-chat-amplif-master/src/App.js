            ...
            <div className="input-area-wrapper">
                <form className="input-container" onSubmit={handleSubmit}>
                    ...
                    <div className="input-row">
                      ...
                      {/* Generischer Sende-Button entfernt, Enter-Taste wird für die Übermittlung verwendet */}
                      {/* Der Button wird für Standard-Chat beibehalten, da die Eingabe ohne Submit-Button nur über ENTER funktioniert */}
